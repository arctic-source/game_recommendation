"""
Game recommendation systme works the best when it has as many games as possible. Hence, this script checks whether
there are any very popular games that were not web scraped correctly (they include NaN values).
"""
