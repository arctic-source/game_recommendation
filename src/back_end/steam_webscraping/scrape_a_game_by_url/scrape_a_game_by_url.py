...
from src.back_end.steam_webscraping.scrape_a_game_by_url.developers.extract_publishers_developers import \
    extract_publishers_developers
from src.back_end.steam_webscraping.scrape_a_game_by_url.game_description.extract_game_description import extract_game_description
from src.back_end.steam_webscraping.scrape_a_game_by_url.genres.extract_genres import extract_genres
from src.back_end.steam_webscraping.scrape_a_game_by_url.price.extract_price import extract_price
from src.back_end.steam_webscraping.scrape_a_game_by_url.release_date.extract_release_date import extract_release_date
from src.back_end.steam_webscraping.scrape_a_game_by_url.reviews.extract_steam_rating import extract_steam_rating
from src.back_end.steam_webscraping.scrape_a_game_by_url.reviews.scrape_reviews import scrape_reviews
from src.back_end.steam_webscraping.scrape_a_game_by_url.steam_id.extract_steam_id import extract_steam_id
from src.back_end.steam_webscraping.scrape_a_game_by_url.tags.extract_tags import extract_tags
from src.back_end.steam_webscraping.scrape_a_game_by_url.title.extract_title import extract_title
