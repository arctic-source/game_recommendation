...
from src.back_end.data_processing.helpers.add_empty_lists_as_nans import add_empty_lists_as_nans


def check_if_nans_exist(dataset: pd.DataFrame, suppress_output: bool) -> bool:
    """Function that checks if any NaN values exist in columns"""
    nans_exist = False
